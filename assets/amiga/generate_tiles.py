...
def doit_tiles_layer_0_8x8(dump_it=False):
    return doit(2,0,0X10,"tiles_layer_0_8x8",ref_clut_index=0XE,dump_it=dump_it)
def doit_tiles_layer_1_8x8(dump_it=False):
    return doit(4,0x120//4,0x40,"tiles_layer_1_8x8",ref_clut_index=5,dump_it=dump_it)
def doit_sprites_16x16(dump_it=False):
    return doit(4,0x20//4,0x1D,"sprites_16x16",ref_clut_index=0,dump_it=dump_it)  # after 0x1D all black

if __name__ == "__main__":
    #doit_tiles_layer_0_8x8(True)
    #doit_tiles_layer_1_8x8(True)
